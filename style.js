! function(e) {
    ...
    (function(t) {
        e.exports.maxScreenWidth = 1920, e.exports.maxScreenHeight = 1080, e.exports
            .serverUpdateRate = 9, e.exports.maxPlayers = 99, e.exports.maxPlayersHard = 99, e.exports.collisionDepth = 6, e.exports.minimapRate = 3e3, e.exports.colGrid =
            ...
            .nameY = 34,  e.exports.skinColors = ["#bf8f54", "#cbb091", "#896c4b", "#fadadc", "#ececec", "#c37373", "#4c4c4c", "#ecaff7", "#738cc3","",
	...
	function Vn(e, t, n, i, r) {
		...
		} else 1 == n.indx && (i.fillStyle = "#0099ff", si(e, t, n.scale, i))
	}
		...
		for (var i, r, s, a = 0; a < N.length; ++a)(_ = N[a]).active && (r = _.x +
			...
			e && ki(r, s, _.scale + (_.blocker || 0)) && (be.globalAlpha = _.hideFromEnemy ?
				.6 : 1, _.isItem ? (i = ri(_), be.save(), be.translate(r, s), be.rotate(
					...
					.strokeStyle = "#0099ff", be.globalAlpha = .3, be.lineWidth = 6, si(0,
			...
			if (r.translate(i.width / 2, i.height / 2), r.rotate(t ? 0 : Math.PI / 2),
				...
				ai(r, "spikes" == e.name ? 5 : 6, e.scale, d), r.fill(), r.stroke(), r.fillStyle =
					"#a5974c", si(0, 0, d, r), r.fillStyle = "#c9b758", si(0, 0, d / 2, r, !
						0)
			} else if ("windmill" == e.name || "faster windmill" == e.name ||//#a5974c normall mills color
				"power mill" == e.name) r.fillStyle = "#f000000", si(0, 0, e.scale, r), r.fillStyle =
				"#f000000", ci(0, 0, 1.5 * e.scale, 29, 4, r), r.fillStyle = "#ff0000", si(
					0, 0, .5 * e.scale, r);
					...
					for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(
						...
						if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
							...
							if ("" != w) {
                                ...
                                window.w = R.weapons;
                                var XPBot = 'AGE: ' + R.age + '➡[' + R.XP + '/' + Math.round(R.maxXP * 10) / 10 + ']';
                                (be.textAlign = "center",//hp number
                                 be.fillStyle = "#fff",
                                 be.lineJoin = "round",
                                 be.font = "14px Hammersmith One",
                                 be.strokeStyle = "red",
                                 be.lineWidth = 6,
							...
							_.health > 0 && (o.healthBarWidth, be.fillStyle = rt, be.roundRect(_.x -
								...
								_ == R || _.team && _.team == R.team ? "#00bfff" : "#ff0000", be.roundRect(
